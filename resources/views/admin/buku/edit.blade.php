                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="live-preview">
                                <form class="row g-3 " action="{{ route('edit.buku', $buku->id) }}" method="POST"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" name="tahun_terbit"
                                            id="validationDefault01" value="{{ $buku->tahun_terbit }}" required>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="deskripsi" class="form-control" id="" cols="30" rows="10">{{ $buku->deskripsi }}</textarea>
                                    </div>
                            </div>
                            <div class="row">
                                <div class="mt-4">
