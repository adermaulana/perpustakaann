                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                    <div class="flex-grow-1">
                                        <h4 class="fs-16 mb-1">MEMBUAT DATA PEMINJAMAN</h4>
                                    </div>
                                </div><!-- end card header -->
                            </div>
                            <!--end col-->
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center">
                                        ...
                                        <div>
                                            <a href="/admin/peminjaman/tambah" class="btn btn-primary">
                                                Tambah Data
                                            </a>
                                        </div>
                                    </div>
                                                ...
                                                @foreach ($peminjaman as $data)
                                                    <tr>
                                                        ...
                                                        @if ($data->status == 'dipinjam')
                                                            <td><span class="btn btn-warning btn-sm">Dipinjam</span>
                                                            </td>
                                                        @else
                                                            <td><span class="btn btn-success btn-sm">Dikembalikan</span></td>
                                                        @endif
                                                        <td>
                                                            <div class="d-flex flex-wrap gap-2">
                                                                <a type="button"
                                                                    href="/admin/peminjaman/{{ $data->id }}/edit"
