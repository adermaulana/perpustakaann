                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="live-preview">
                                <form class="row g-3 " action="/admin/anggota/tambah" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-md-12">
                                        <label for="validationDefault01" class="form-label">NOMOR ANGGOTA</label>
                                        <input type="text" class="form-control" value="{{ $nomor_anggota }}" readonly
                                            style="background-color: #cccccc;" id="validationDefault01" value=""
                                            required>
